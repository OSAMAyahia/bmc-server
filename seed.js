      ...
      data: {
        ar: {
          ...
          items: [
            ...
            { title: 'التسويق الرقمي', desc: 'حلول تسويق إلكتروني متكاملة تساعدك على جذب العملاء وزيادة المبيعات ورفع حضور علامتك التجارية.' },
            { title: 'استشارات تقنية ودعم', desc: 'نقدم استشارات تقنية وخطط تحول رقمي شاملة، مع دعم مستمر وصيانة دورية لضمان استمرارية أعمالك.' },
          ],
        },
        en: {
          label: 'Our Services',
          ...
          items: [
            ...
            { title: 'Digital Marketing', desc: 'Integrated digital marketing solutions that help you attract customers, increase sales, and strengthen your brand presence.' },
...
const seedServices = async () => {
  ...
  const services = [
    ...
    },
    {
      ...
      descAr: 'نقدم استشارات تقنية وخطط تحول رقمي شاملة مع دعم مستمر وصيانة دورية.',
      ...
      detailTitleEn: 'Tech',
      detailTitleSpanAr: 'تقنية',
      detailTitleSpanEn: 'Consulting',
      detailDescAr: 'نقدم استشارات تقنية وخطط تحول رقمي شاملة، مع دعم مستمر وصيانة دورية لضمان استمرارية ونمو أعمالك.',
